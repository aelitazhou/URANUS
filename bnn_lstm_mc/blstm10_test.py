...
# [sample, time_step, loc, 12_step]
preds = np.empty([samples, t_step, 10, step])
print(preds.shape)
...
# [time_step, loc, 12_step, mu_std]
preds_final = np.empty([t_step, 10, step, 2])
