...
from env_sdp import MOESimulator
...
np.save('RLAUP/SDP_' + save_var + '_R', rewards)
np.save('RLAUP/SDP_' + save_var + '_L', leftovers)
np.save('RLAUP/SDP_' + save_var + '_A', actions)
np.save('RLAUP/SDP_' + save_var + '_U', utilities)
np.save('RLAUP/SDP_' + save_var + '_P', penalties)
