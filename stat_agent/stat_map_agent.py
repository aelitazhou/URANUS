...
sim.ti = 24   # Starting from the Monday (a work day, and see the difference...)
...
np.save('RLAUP/ST_' + save_var + '_R', rewards)
np.save('RLAUP/ST_' + save_var + '_L', leftovers)
np.save('RLAUP/ST_' + save_var + '_A', actions)
np.save('RLAUP/ST_' + save_var + '_U', utilities)
np.save('RLAUP/ST_' + save_var + '_P', penalties)
