...
params = {
    ...
    #'num_agents': 1,               # 5 agents in total
    ...
    'penalty_w':   500000,                      # penalty weight, large scalar
    ...
    'pred_grid': 3, # dp: (1, 2, 3, 6, 9, 12) how much time slots of prediction we use; no agent/stat: 1/12
    'num_agents': 3,               # 5 agents in total
