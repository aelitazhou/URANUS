...
from env_lcvar import MOESimulator
...
for s in range(step_size): 
    ...
    print(sim.cvar_x, sim.cvar_y)
    print(sim.cvar_x_p, sim.cvar_y_p)
    '''
    actions.append(action)
...
np.save('learn_cvar/cvar_x_' + save_var, cvar_x)
np.save('learn_cvar/cvar_y_' + save_var, cvar_y)
