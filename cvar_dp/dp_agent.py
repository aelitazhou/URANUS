...
save_var = str(params['penalty_w']) + '_' + str(params['x_cost']) + '_' + str(params['y_cost']) + '_' + str(params['i_cost']) + '_' + str(params['pred_grid']) + '_' + str(params['num_agents']) + str(params['eps'])

np.save('RLA/DP_' + save_var + '_R', rewards)
np.save('RLA/DP_' + save_var + '_L', leftovers)
np.save('RLA/DP_' + save_var + '_A', actions)
